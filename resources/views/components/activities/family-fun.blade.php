...
@section('container')
			<!-- main banner -->
			<section class="banner banner-inner parallax" data-stellar-background-ratio="0.5" id="activity-summer">
				<div class="banner-text">
					<div class="center-text text-center">
						<div class="container">
							<h1>Summer &amp; Family Fun</h1>
			...
			<main id="main">
					...
					<div class="container">
						<div class="row">
							<div class="col-sm-8 col-md-9 text-holder">
								<h2 class="title-heading">Walking &amp; Trekking Holidays</h2>
							...
							<div class="col-sm-4 col-md-3 map-col">
								<div class="holder">
									<div class="map-holder">
										<img src="img/icons/ico-summer.svg" height="300" width="200" alt="image description">
									</div>
									<div class="info">
										<div class="slot">
				...
				<!-- content block with bocxed article -->
				<article class="content-block article-boxed">
					<div class="container">
						<header class="content-heading">
							<h2 class="main-heading">TREKKING THEMES</h2>
							<span class="main-subtitle">Chose from various walking and trekking adventures in 2016.</span>
