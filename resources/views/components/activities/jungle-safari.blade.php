...
@section('container')
			<!-- main banner -->
			<section class="banner banner-inner parallax" data-stellar-background-ratio="0.5" id="activity-jungle">
				<div class="banner-text">
					<div class="center-text text-center">
						<div class="container">
							<h1>Wildlife &amp; Jungle Safaris</h1>
							...
							<div class="col-sm-4 col-md-3 map-col">
								<div class="holder">
									<div class="map-holder">
										<img src="img/icons/ico-antlers.svg" height="300" width="200" alt="image description">
									</div>
									<div class="info">
										<div class="slot">
